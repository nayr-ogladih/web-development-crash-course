...
async function loadFacts() {
  const res = await fetch(
    "https://xosmubhghtehtswwsjda.supabase.co/rest/v1/facts",
    {
      headers: {
        apikey:
        ...
        authorization:
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inhvc211YmhnaHRlaHRzd3dzamRhIiwicm9sZSI6ImFub24iLCJpYXQiOjE2NzMxMzU1NTMsImV4cCI6MTk4ODcxMTU1M30.rERpWpgi6t76xWdCQKxW6tdcZZNFO-q5mHifi9ugMoI",
      },
    }
  );
...
function createFactsList(dataArray) {
  // factsList.insertAdjacentHTML("afterbegin", "<li>Ryan</li>");
